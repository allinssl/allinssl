...
export const useDnsAnalysisStare = defineStore('dnsAnalysis', () => {
	...
	const createRecord = async (params: CreateDnsRecordRequest) => {
		isLoading.value = true
		try {
			const { fetch, data, message } = createDnsRecord(params)
			message.value = true
			await fetch()
			return data.value
		} catch (err) {
	...
	const updateRecord = async (params: UpdateDnsRecordRequest) => {
		isLoading.value = true
		try {
			const { fetch, data, message } = updateDnsRecord(params)
			message.value = true
			await fetch()
			return data.value
		} catch (err) {
	...
	const deleteRecord = async (params: DeleteDnsRecordRequest) => {
		isLoading.value = true
		try {
			const { fetch, data, message } = deleteDnsRecord(params)
			message.value = true
			await fetch()
			return data.value
		} catch (err) {
	...
	const pauseRecord = async (params: ToggleDnsRecordRequest) => {
		isLoading.value = true
		try {
			const { fetch, data, message } = pauseDnsRecord(params)
			message.value = true
			await fetch()
			return data.value
		} catch (err) {
	...
	const startRecord = async (params: ToggleDnsRecordRequest) => {
		isLoading.value = true
		try {
			const { fetch, data, message } = startDnsRecord(params)
			message.value = true
			await fetch()
			return data.value
		} catch (err) {
